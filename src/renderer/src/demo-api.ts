 ...
 * browser tab, or embedded in a Cookrew browser) there is no preload bridge,
...
const DEMO_RESPONSES: Record<string, string> = {
  ...
  about: 'Cookrew — open-source Cookrew clone. Electron + React Flow + xterm.js + node-pty.\r\nThis browser demo simulates the shell; the desktop app runs real PTYs.'
}
