...
/** The C hand on its own: the phone bar's mark in portrait. The bar is one line, so the lockup
    gives way to the hand until landscape has the room (styles.css swaps them at 700 px). */
