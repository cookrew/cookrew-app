...
import { faviconSvg } from '../../src/shared/brand-mark'
...
/** The wireframe hand, cyan on the dark tile — the same geometry as the app's mark. */
export const FAVICON_SVG = faviconSvg()
