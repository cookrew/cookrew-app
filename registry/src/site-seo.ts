...
/** The favicon: the voxel hand on the dark tile — the same bytes the app's bar draws. */
export const FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect width="32" height="32" rx="7" fill="#14110a"/><image href="${VOXEL_HAND_72}" x="2" y="2" width="28" height="28" preserveAspectRatio="xMidYMid meet"/></svg>`
